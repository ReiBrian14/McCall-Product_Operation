...
<body>
                ...
                <form action="" method="POST">
                    <div class="mb-3 row">
                        ...
                        <div class="col order-5">
                            <input type="text" class="form-control col-md-1" id="id_efficiency" name="id_efficiency" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
    ...
    <?php
        ...
        if (isset($_POST['save'])) {
            ...
            $cek_data3 = mysqli_num_rows($koneksi->query("SELECT * FROM glue WHERE id_hasilakhir = '$uji' AND id_sumber = '$id_efficiency' "));
                    if ($cek_data3 > 0) {
                        $update = $koneksi->query("update efficiency set nilai_excution = '$nilai_accuracy',nilai_efficiency='$nilai_efficiency',persentase='$persentase',kategori='$kategori' where id_efficiency = '$id_efficiency'");
                ...
                if ($cek_data > 0) {
                    ...
                    echo "<meta http-equiv='refresh' content='0;url=?page=pages/inputform/penilaian/efficiency'>";
                }else{

                    $cek_data2 = mysqli_num_rows($koneksi->query("SELECT * FROM glue WHERE id_hasilakhir = '$uji' AND tipe_sumber = 'efficiency' "));
                    if ($cek_data2 > 0){
