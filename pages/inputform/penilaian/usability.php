...
<body>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="pertanyaan_efficiency" class="form-control" name="communicativeness"
                                id="communicativeness" onchange="myfunction(this)">
                                <option value="">- Pilih -</option>
                                <?php
                                include '/../../../model/koneksi.php';
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="pertanyaan_efficiency" class="form-control" name="communicativeness1"
                                id="communicativeness1" onchange="myfunction1(this)">
                                <option value="">- Pilih -</option>
                                <?php
                                include '/../../../model/koneksi.php';
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="pertanyaan_efficiency" class="form-control" name="communicativeness2"
                                id="communicativeness2" onchange="myfunction2(this)">
                                <option value="">- Pilih -</option>
                                <?php
                                    include '/../../../model/koneksi.php';
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="pertanyaan_efficiency" class="form-control" name="operability"
                                id="operability" onchange="myfunction4(this)">
                                <option value="">- Pilih -</option>
                                <?php
                                        include '/../../../model/koneksi.php';
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="pertanyaan_efficiency" class="form-control" name="operability1"
                                id="operability1" onchange="myfunction5(this)">
                                <option value="">- Pilih -</option>
                                <?php
                                    include '/../../../model/koneksi.php';
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select name="pertanyaan_efficiency" class="form-control" name="operability2"
                                id="operability2" onchange="myfunction6(this)">
                                <option value="">- Pilih -</option>
                                <?php
                                    include '/../../../model/koneksi.php';
    ...
    <?php
        ...
        if (isset($_POST['save'])) {
            ...
            $cek_data3 = mysqli_num_rows($koneksi->query("SELECT * FROM glue WHERE id_hasilakhir = '$uji' AND id_sumber = '$id_usability' "));
                    if ($cek_data3 > 0) {
                        $update = $koneksi->query("update usability set nilai_communicativeness = '$nilai_communicativeness',nilai_operability='$nilai_operability',nilai_training='$nilai_training',nilai_usability='$nilai_usability',persentase='$persentase',kategori='$kategori' where id_usability = '$id_usability'");
                ...
                if ($cek_data > 0) {
                    ...
                    echo "<meta http-equiv='refresh' content='0;url=?page=pages/inputform/penilaian/usability'>";
                }else{
                    $cek_data2 = mysqli_num_rows($koneksi->query("SELECT * FROM glue WHERE id_hasilakhir = '$uji' AND tipe_sumber = 'usability' "));
                    if ($cek_data2 > 0){
...
// tampilan operability


    function myfunction4(selectElement) {
        var selectedValue = selectElement.value;
            var inputElement = document.getElementById("bobot4");
            inputElement.value = selectedValue;
    ...
    function myfunction6(selectElement) {
        var selectedValue = selectElement.value;
            var inputElement = document.getElementById("bobot6");
            inputElement.value = selectedValue;
    }
