...
<body>
    ...
    <center>
        <table width="100%" border="0" align="center" cellspacing="1" cellpadding="1" class="no-style">
            <tbody>
                <tr>
                    ...
                    <td valign="top"><br><br>
                        <center>
                            <h1 style="color:black;font-size:16px;text-transform:uppercase;">ReysStone Gym Fitness Factory<br>
                            </h1>
                            ...
                            <p><br><span style="color:black;font-size:11px;"> Telp. :</span>
                                ...
                                <span style="color:black;font-size:11px;"> Website : 
                                </span>
                            </p>
                    </td>
                    <td width="140px"></td>
        ...
        <center>
            <h2>Loporan Hasil Pengukuran Sistem Informasi Bisnis</h2>
    ...
    <br>
    <center>
        <div style="width:40%;  float:right;">Padang, 27-Juni-2023</div><br><br>
        <div style="width:40%;  float:right;">Mengetahui,</div><br>
        <div style="width:40%;  float:right;">Pengelola</div><br><br><br><br><br>
